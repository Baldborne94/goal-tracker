...
export default function KakeeboClient() {
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-6">
      <h1 className="text-2xl font-bold text-[#ede9ff] mb-6">📒 Registro Spese</h1>
          ...
          {budget ? (
            <>
              ...
              <div className="mt-3 pt-3 border-t border-[#3b2d6e]">
                {budget.closed ? (
                  <p className="text-center text-amber-400 text-xs font-medium">✅ Mese completato — premio riscattato!</p>
                ) : closeMsg ? (
                  ...
                  >
                    🏆 Riscatta premio mensile (+25 XP)
                  </button>
                ) : (
                  <p className="text-center text-red-400 text-xs">Budget superato — nessun premio disponibile</p>
                )}
              </div>
            </>
          ) : (
